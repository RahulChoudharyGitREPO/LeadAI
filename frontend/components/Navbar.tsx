...
export default function Navbar() {
  return (
    <header className="h-20 glass border-b border-white/20 sticky top-0 z-40 px-8 flex items-center justify-between">
      <div className="flex-1 max-w-md">
        <div className="relative group">
          ...
          <Input 
            ...
            className="pl-10 bg-white/50 border-white/40 focus:bg-white transition-all rounded-xl subtle-shadow"
          />
        </div>
      </div>
